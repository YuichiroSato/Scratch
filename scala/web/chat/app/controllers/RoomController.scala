...
@Singleton
class RoomController @Inject()(cc: ControllerComponents, system: ActorSystem, materializer: Materializer, chatRoomService: ChatRoomService)(database: Database) extends AbstractController(cc) {
